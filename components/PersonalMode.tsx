...
import { Settings, Volume2, ChevronRight, Activity, LogOut, AlertTriangle, Mail, Lock, LogIn, UserPlus, Loader2, Moon, Sun, User, Database, Save, X } from 'lucide-react';
import { User as FirebaseUser, signOut, signInWithEmailAndPassword, createUserWithEmailAndPassword, signInAnonymously, updateProfile } from 'firebase/auth';
        ...
        <div className="h-full bg-slate-50 dark:bg-slate-950 overflow-y-auto transition-colors duration-300 relative">
            ...
            <div className="min-h-full flex flex-col items-center justify-center p-6 pb-24">
                <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 p-8 text-center transition-colors duration-300 relative">
                    ...
                    {user ? (
                        <>
                            <div className="w-20 h-20 bg-indigo-100 dark:bg-indigo-900/30 rounded-full flex items-center justify-center mx-auto mb-6 text-indigo-600 dark:text-indigo-400 shadow-sm"><Settings size={40} /></div>
